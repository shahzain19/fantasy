...
public enum ModToolMaterials implements ToolMaterial {
    PINK_GARNET(ModTags.Blocks.INCORRECT_FOR_MOON_LIT_TOOL,
            1200, 5.0F, 4.0F, 22, () -> Ingredient.ofItems(ModItems.PINK_GARNET)),

    OBSIDIANFORGE(ModTags.Blocks.INCORRECT_FOR_OBSIDIANFORGE_TOOL,
            1750, 6.5F, 5.0F, 10, () -> Ingredient.ofItems(ModItems.ELIXIR_GEM));
